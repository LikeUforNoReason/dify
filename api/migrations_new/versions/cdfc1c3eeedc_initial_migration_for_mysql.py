"""initial_migration_for_mysql

Revision ID: cdfc1c3eeedc
Revises:
Create Date: 2025-04-27 08:16:47.287633
...
def upgrade():
    ...
    op.create_table('app_annotation_hit_histories',
                    ...
                    sa.Column('annotation_content', sa.Text(), nullable=False),
    ...
    op.create_table('conversations',
                    ...
                    sa.Column('system_instruction_tokens', sa.Integer(), nullable=False),
                    sa.Column('status', sa.String(length=255), nullable=False),
    ...
    op.create_table('dataset_retriever_resources',
                    ...
                    sa.Column('data_source_type', sa.Text(), nullable=True),
                    sa.Column('segment_id', models.types.StringUUID(), nullable=True),
    ...
    op.create_table('datasets',
                    ...
                    sa.Column('built_in_field_enabled', sa.Boolean(), nullable=False),
    ...
    op.create_table('external_knowledge_bindings',
                    ...
                    sa.Column('dataset_id', models.types.StringUUID(), nullable=False),
                    sa.Column('external_knowledge_id', models.types.StringUUID(), nullable=False),
                    sa.Column('created_by', models.types.StringUUID(), nullable=False),
                    sa.Column('created_at', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
                    sa.Column('updated_by', models.types.StringUUID(), nullable=True),
                    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    ...
    op.create_table('message_agent_thoughts',
                    ...
                    sa.Column('tool_labels_str', sa.Text(), nullable=False),
                    sa.Column('tool_meta_str', sa.Text(), nullable=False),
                    ...
                    sa.Column('message_price_unit', sa.Numeric(precision=10, scale=7), nullable=False),
                    ...
                    sa.Column('answer_price_unit', sa.Numeric(precision=10, scale=7), nullable=False),
                    sa.Column('tokens', sa.Integer(), nullable=True),
    ...
    op.create_table('tool_model_invokes',
                    ...
                    sa.Column('answer_tokens', sa.Integer(), nullable=False),
                    sa.Column('answer_unit_price', sa.Numeric(precision=10, scale=4), nullable=False),
                    sa.Column('answer_price_unit', sa.Numeric(precision=10, scale=7), nullable=False),
                    sa.Column('provider_response_latency', sa.Float(), nullable=False),
    ...
    op.create_table('workflows',
                    ...
                    sa.Column('type', sa.String(length=255), nullable=False),
                    sa.Column('version', sa.String(length=255), nullable=False),
                    sa.Column('marked_name', sa.String(length=255), server_default='', nullable=False),
                    sa.Column('marked_comment', sa.String(length=2048), server_default='', nullable=False),
                    ...
                    sa.Column('conversation_variables', sa.Text(), nullable=False),
    ...
    op.create_table('messages',
                    ...
                    sa.Column('message_tokens', sa.Integer(), nullable=False),
